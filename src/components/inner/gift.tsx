...
import { Wishlist } from "../icons/indexs";
      ...
      <div className="container mx-auto px-6">
        {activeTab === "all" && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 mb-6">
              All your gifts will appear here.
            </p>
        ...
        {activeTab === "unopened" && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 mb-6">
              Gifts you haven{`'`}t opened yet will appear here.
            </p>
            <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-md transition">
              Browse Games
            </button>
        ...
        {activeTab === "received" && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 mb-6">
              Gifts you've received will appear here.
            </p>
            <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-md transition">
              Browse Games
            </button>
        ...
        {activeTab === "sent" && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400">
              Thinking of treating someone? Find a game in the store and gift it
              to a friend.
            </p>
